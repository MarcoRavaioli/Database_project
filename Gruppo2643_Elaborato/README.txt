...
Per accedere al database in modalità Admin occorre inserire la seguente password = admin321

Per accedere come utente è possibile registrarsi come nuovo utente