...
public class AbbonamentoEditFrame extends JFrame {
    ...
    public AbbonamentoEditFrame(String[] currentValues) {
        setTitle("Modifica Abbonamento");
        setSize(400, 250);
